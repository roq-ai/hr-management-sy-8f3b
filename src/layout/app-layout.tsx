...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Favorites', path: '/favorites', entity: 'favorites', service: AccessServiceEnum.PROJECT, icon: FiStar },
    {
      name: 'Mp 3 Players',
      path: '/mp-3-players',
      entity: 'mp3_player',
    ...
    { name: 'Playlists', path: '/playlists', entity: 'playlist', service: AccessServiceEnum.PROJECT, icon: FiList },
    { name: 'Songs', path: '/songs', entity: 'song', service: AccessServiceEnum.PROJECT, icon: FiMusic },
