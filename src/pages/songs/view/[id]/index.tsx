...
import { getSongById } from 'apiSdk/songs';
import { SongInterface } from 'interfaces/song';
import { FavoritesListPage } from 'pages/favorites';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('song', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/songs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Artist" text={data?.artist} />
                ...
                <FormListItem
                  label="Release Date"
                  text={
                    data?.release_date ? format(parseISO(data?.release_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
