  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Step into the rhythm of your day with HR Management System - Your personal guide to discovering and enjoying music. Uncover artists, titles and the perfect MP3 player for your favorite songs."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1515010137531-66995c7f40e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxNUDMlMjBwbGF5ZXJ8ZW58MHx8fHwxNjk0MDIyODI0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@kpebedko_o?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Oleg Sergeichik`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Step into the rhythm of your day with HR Management System - Your personal guide to discovering and enjoying music. Uncover artists, titles and the perfect MP3 player for your favorite songs.`}
            </Text>
            <Box
